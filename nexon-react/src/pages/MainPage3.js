      ...
      <div className="main3sub">
        <ul>
          <li>
            ...
            <p>
              최근 넥슨 그룹 내에서 넥슨게임즈의 존재감이 재부각되고 있 다. 기존
              작품이 흥행 역주행을보이고 있는 가운데 자체 개발 력 강화로
          ...
          <li>
            ...
            <p>
              넥슨게임즈가 올해 300여명 규모 채용을 진행한다. 인재 확보 를 통해
              신작 개발과 글로벌 시장 진출에 박차를 가하겠다는
              포석이다.넥슨게임즈는 루트슈터 게임 '퍼스트 디센던트', 3인 칭슈팅…
            </p>
          </li>
        </ul>
      </div>
